...
class ScreenReaderController {
    ...
    resolveBundledNVDADllPath() {
        ...
        const candidatesByArch = {
            x64: [
                path.join(resourcesPath, 'native', 'win64', 'nvdaControllerClient64.dll'),
                path.join(resourcesPath, 'native', 'win64', 'nvdaControllerClient.dll'),
                path.join(__dirname, 'native', 'win64', 'nvdaControllerClient64.dll'),
                path.join(__dirname, 'native', 'win64', 'nvdaControllerClient.dll')
            ],
            ia32: [
                path.join(resourcesPath, 'native', 'win32', 'nvdaControllerClient32.dll'),
                path.join(resourcesPath, 'native', 'win32', 'nvdaControllerClient.dll'),
                path.join(__dirname, 'native', 'win32', 'nvdaControllerClient32.dll'),
                path.join(__dirname, 'native', 'win32', 'nvdaControllerClient.dll')
            ],
            arm64: [
                path.join(resourcesPath, 'native', 'winarm64', 'nvdaControllerClientARM64.dll'),
                path.join(resourcesPath, 'native', 'winarm64', 'nvdaControllerClient.dll'),
                path.join(resourcesPath, 'native', 'win64', 'nvdaControllerClient64.dll'),
